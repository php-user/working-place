...
class Category extends \Application\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Category' . "\0" . 'isVisible', '' . "\0" . 'Application\\Entity\\Category' . "\0" . 'categoryOrder', '' . "\0" . 'Application\\Entity\\Category' . "\0" . 'parent'];
        }
    ...
    public function setCategoryOrder($categoryOrder)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategoryOrder', [$categoryOrder]);

        return parent::setCategoryOrder($categoryOrder);
    }
    ...
    public function getCategoryOrder()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCategoryOrder', []);

        return parent::getCategoryOrder();
    }
